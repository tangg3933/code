...
if __name__ == "__main__":
    ...
    for point in points:
        ...
        points2D.append((x, y))
    # points2D = [(101, 47), (32, 40), (21, 90), (65, 100), (98, 64), (81, 43), (51, 20), (75, 82), (90, 34), (38, 101)]

    points2D.sort()  # First sort by the x-axis to find the leftmost and rightmost points
    borders = []  # Boundary point set
    ...
    results.append(results[0])  # Connect the last point to the source point and draw a closed line (this is only handled when drawing)

    show_result(points2D, results)  # Show static results
    # draws(points2D, results, "result2.gif")  # Plot dynamic results
    # draws(points2D, draw_line_lists, "process2.gif")  # Draw dynamic process
